...
describe('eulerFromMat3', () => {
  ...
  it('performs a "two big revolutions" case (X and Z are big)', () => {
    ...
    expect(subject).toBeCloseToArray([0.524, -2.88, -0.174]);
  });
