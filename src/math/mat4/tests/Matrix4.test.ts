...
const rawMatrixLookAtFrom345: RawMatrix4 = [
  0.8574929257125442, 0, -0.5144957554275265, 0, -0.2910427500435996,
  0.824621125123532, -0.48507125007266594, 0, 0.4242640687119285,
  0.565685424949238, 0.7071067811865475, 0, 3, 4, 5, 1,
];

const rawMatrixInvLookAtFrom345: RawMatrix4 = [
  0.8574929257125443, -0.2910427500435996, 0.42426406871192857, 0, 0,
  0.8246211251235323, 0.5656854249492381, 0, -0.5144957554275266,
  -0.48507125007266605, 0.7071067811865476, 0, 2.2204460492503136e-16,
  4.440892098500627e-16, -7.071067811865476, 1,
];
...
const rawMatrixLookAtFrom345To678: RawMatrix4 = [
  ...
  -0.5773502691896257, -0.5773502691896257, -0.5773502691896255, 0, 3, 4, 5, 1,
];
...
const rawMatrixLookAtFrom345To678Up100: RawMatrix4 = [
  2.220446049250313e-16, 0.7071067811865474, -0.7071067811865475, 0,
  0.8164965809277259, -0.40824829046386313, -0.4082482904638629, 0,
  -0.5773502691896257, -0.5773502691896257, -0.5773502691896257, 0, 3, 4, 5, 1,
];
...
describe('Matrix4', () => {
  ...
  describe('lookAt', () => {
    it('should create a lookAt matrix correctly with 1 argument', () => {
      const matrix = Matrix4.lookAt(new Vector3([3.0, 4.0, 5.0]));
    ...
    it('should create a lookAt matrix correctly with 3 arguments', () => {
      ...
      expect(matrix.elements).toBeCloseToArray(
        rawMatrixLookAtFrom345To678Up100,
      );
    });
  });
  ...
  describe('lookAtInverse', () => {
    it('should create the inverse of a lookAt matrix correctly with 1 argument', () => {
      const matrix = Matrix4.lookAtInverse(new Vector3([3.0, 4.0, 5.0]));
    ...
    it('should create a lookAt matrix correctly with 3 arguments', () => {
      ...
      expect(matrix.elements).toBeCloseToArray(
        rawMatrixInvLookAtFrom345To678Up100,
      );
    });
  });
